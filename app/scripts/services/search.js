...
angular.module('collegeScorecardApp')
  .factory('search', function($resource) {
      ...
      // Public API here
      return $resource('https://api.data.gov/ed/collegescorecard/v1/schools.json?2014.student.size__range=:minClass..:maxClass&api_key=xqfqZmKUIPqNYDG8WVRvF3079XzgGgXtyJSloKzQ', {}, {
